...
mc.sync_send_angles(Solution(mc, [55,-210,50,-180,0,0], "P1"),30)
LinearMotionA(mc, Solution(mc, [52.5,-207.5,-5,-180,0,0], "P1"), 100)
mc.set_color(0,255,0)
mc.set_color(0,255,0)
mc.set_color(0,255,0)
time.sleep(1)
LinearMotionA(mc, Solution(mc, [55,-210,50,-180,0,0], "P1"), 100)
